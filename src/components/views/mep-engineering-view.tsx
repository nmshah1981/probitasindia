    ...
    <>
      <PageHeader
        ...
        meta={[
          ...
          { label: "Services", value: "Design + Peer Review" },
          { label: "Coordination", value: "Integrated BIM / Revit" },
        ]}
      />
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            <div className="lg:col-span-4">
              ...
              <DisplayHeading as="h2" className="mt-4">
                Two specialized building services.
              </DisplayHeading>
      ...
      <CtaBand
        ...
        title="Planning mechanical, electrical or plumbing packages?"
        body="Tell us about your project and we'll route your brief to our MEP engineering team."
