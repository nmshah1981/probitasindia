...
export function StructuralDesignView({
  ...
  const related = services
    .filter((s) => s.slug !== "structural-design")
  ...
  return (
    <>
      <PageHeader
        ...
        image={svc.heroImage}
        imageAlt="[STRUCTURAL DESIGN HERO IMAGE — OWNER TO PROVIDE]"
        tags={["Concept", "Detailed Design", "Documentation", "Construction Support"]}
        meta={[
      ...
      <ContentBlock
        index="01"
        eyebrow="Overview"
        title="[STRUCTURAL DESIGN OVERVIEW — OWNER TO PROVIDE]"
        sidebar={
      ...
      >
        <p>
          [STRUCTURAL DESIGN OVERVIEW — OWNER TO PROVIDE: A clear description of
          the firm&apos;s structural engineering practice — its philosophy,
          material fluency, structural systems expertise and how it approaches
          design problems.]
        </p>
        <p>
